  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience effortless mobility with Car Sharing Application - Your gateway to a sustainable, convenient, and economical ride-sharing solution."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience effortless mobility with Car Sharing Application - Your gateway to a sustainable, convenient, and economical ride-sharing solution.`}
            </Text>
            <Box
